...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['play harmonica', 'exercise'];
    progressListArray = ['study Javascript', 'finish the course'];
    completeListArray = ['finish the project for contest', "clean the garden"];
    onHoldListArray = ['holiday'];
  }
}
